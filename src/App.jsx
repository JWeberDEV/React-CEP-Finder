    ...
    <>
      <Container>
        ...
        <Row className="d-flex justify-content-center p-3">
          ...
          <Col md='11'>
            <Input type="text" placeholder="Informe o cep..." value={input} onChange={(e) => setInput(e.target.value)}/>
          </Col>
          ...
          <Col md='1'>
            ...
            <Button type="button" size="sm" disabled={isLoading} onClick={()=>searchCep()}>
              ...
              { isLoading ? <Spinner color="light" type="grow" /> : <AiOutlineSearch size={25} color="#fff" />}
            </Button>
          </Col>
          {cep &&(
            // prop é uma propriedade que você cria para um componente
            <Col md='12' className=" border rounded-4 p-3 mt-3 bg-white">
              <Form cep={cep.cep} logradouro={cep.logradouro} complemento={cep.complemento} bairro={cep.bairro} localidade={cep.localidade} uf={cep.uf}/>
            </Col>
          )}
        </Row>
      </Container>
